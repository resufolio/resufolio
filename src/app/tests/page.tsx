    ...
    return (
        ...
        <div className="bg-white p-3 flex">
            <DragDropContext onDragEnd={handleDragEnd}>
                ...
                <section className="inline-flex w-full flex-grow-0 border border-slate-300 p-4">
                            ...
                            {(provided) => (
                                <div
                                    ...
                                    {Array.from({ length: 3 }).map((_, innerIndex) => (
                                        <Draggable key={innerIndex} draggableId={`draggable-${index}-${innerIndex}`} index={innerIndex}>
                                            {(provided) => (
                                                <div
                                                    className="bg-gray-200 p-3 mb-5 w-48 rounded-lg user-select-none"
                                                    ref={provided.innerRef}
